...
public class DoublePoint {
	 ...
	 * 
	 * @post The point's X coordinate minus the object's X coordinate is between 0
	 *       and 1. | this.getX() - result.getX() >= 0 && this.getX() -
	 *       result.getX() < 1
	 * @post The point's Y coordinate minus the object's Y coordinate is between 0
	 *       and 1. | this.getY() - result.getY() >= 0 && this.getY() -
	 *       result.getY() < 1
	 */
